          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-navy-600">john@example.com</p>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="bg-navy-100 hover:bg-navy-200 text-navy-700 p-3 rounded-full transition-colors"
                >
          ...
          <form className="space-y-6">
            <div>
              ...
              <input
                ...
                id="name"
                name="name"
                className="w-full px-4 py-3 border border-navy-300 rounded-lg focus:ring-2 focus:ring-navy-500 focus:border-navy-500 outline-none transition-all"
            ...
            <button
              type="submit"
              className="w-full bg-navy-700 hover:bg-navy-800 text-white px-6 py-3 rounded-lg font-medium transition-all transform hover:scale-105"
            >
              Send Message
            </button>
          </form>
